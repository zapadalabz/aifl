...
const BBMessageDisplay = ({ messages, messagesEndRef, chatSettings, setChatSettings, isThinking, user }) => {
      ...
      return (
        <div key={i} className="messageIncoming">
          ...
          <div className="d-flex flex-column">
              ...
              {isThinking && i === messages.length - 1 && <div className="thinking" />}
          </div>
        </div>
      );
    }if (m.role === "user") {
...
export default BBMessageDisplay;
